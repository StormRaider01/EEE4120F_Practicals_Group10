...
function mandelbrot_serial(width, height, max_iterations) %Add necessary input arguments 
...
function mandelbrot_parallel(width, height, max_iterations) %Add necessary input arguments 
